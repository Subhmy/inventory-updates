"""
UPDATE 33kV LINE DASHBOARD
GID: 708410770 - Automatically adds upload date
"""
...
SHEET_GID = os.getenv('LINE_33KV_GID')
COLLECTION_NAME = "line_33kv"
...
def fetch_data():
    ...
    log_message(f"📤 Fetching 33kV Line data...")
...
def transform_data(data):
    ...
    for row in data:
        doc = {
            ...
            "towers": safe_int(row.get('Towers')),
...
def main():
    print("\n" + "="*60)
    print("⚡ 33kV LINE DASHBOARD UPDATER")
    print("="*60)
